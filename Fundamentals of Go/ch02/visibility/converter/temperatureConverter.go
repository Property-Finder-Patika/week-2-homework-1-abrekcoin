// converter package includes a function to convert between celcius, fahrenheit, and kelvin.
package converter

// Convert function makes the conversions between celcius, fahrenheit, and kelvin.
